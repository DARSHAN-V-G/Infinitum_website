...
const { registerForEvent, getAllEvents, getStudentsByEvent,createEvent ,generalRegistration} = require('../controllers/eventController');
...
router.get('/general',authMiddleware,generalRegistration);
